...
open class FittingGridFlowLayout: UICollectionViewFlowLayout {
    ...
    fileprivate(set) open var columnCount:Int = 0
    ...
    open var itemTargetWidth:CGFloat = 380.0 {
        didSet {
    ...
    open var singleColumnRatio:CGFloat = 0.5625 {
        didSet {
    ...
    open var multiColumnRatio:CGFloat = 0.75 {
        didSet {
    ...
    open func columnCountForWidth(_ contentWidth:CGFloat) -> Int {
    ...
    open func itemSizeForWidth(_ contentWidth:CGFloat) -> CGSize {
        ...
        let itemSize:CGSize
        if (columnCount <= 1) {
            itemSize = CGSize(width: itemSpace, height: self.singleColumnRatio * itemSpace);
        } else {
